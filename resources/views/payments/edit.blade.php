        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form class="form-horizontal form-material mx-2" action="{{ route('payments.update',$payment->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text"
                                    class="form-control form-control-line" name="transaction_date" id="transaction_date" value="{{$payment->transaction_date}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text"
                                    class="form-control form-control-line" name="cust_name" id="cust_name" value="{{$payment->cust_name}}">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text"
                                    class="form-control form-control-line" name="order_type" id="order_type" value="{{$payment->order_type}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <table class="table mb-0 table-hover align-middle text-nowrap border">
                                ...
                                <form action="">
                                    ...
                                    <tr>
                                        <td colspan="2" style="text-align:right;">Payment Method</td>
                                        <td>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="payment_method" value="TUNAI" > TUNAI
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="payment_method" value="EDC" > EDC
                                            </label>
                                        </div>
                                        </td>
                                    </tr>
                                    <tr class="tunai" id="bayarTUNAI">
                                        <td colspan="2" style="text-align:right;">Bayar</td>
                                        <td><input type="text" name="jml_bayar" id="jml_bayar" /></td>
                                    </tr>
                                    <tr class="tunai" id="kembaliTUNAI">
